...
class PyramidVisionTransformerMM(BaseModule):
    ...
    def train(self, mode=True):
        ...
        super(PyramidVisionTransformerMM, self).train(mode)
        self._freeze_stages()
