...
train_pipeline = [
    ...
    dict(
        type="CollectData",
        keys=["img", "ref_expr_inds", "gt_bbox", "text_attention_mask", "gt_mask"],
    ),
]
...
model = dict(
    ...
    vis_enc=dict(
        ...
        pretrain="pretrain_weights/beit3_large_indomain_patch16_224.pth",
    ),
    lan_enc=None,
    fusion=None,
    head=dict(
        ...
        num_tgqg_layers=2,
        score_attn_loss_weight=32.,
        decoder_attn_loss_weight=1.,
        img_enhance=True,
    ),
)
...
# load_from="work_dir/paper_exp/sota_model/sota_large/ViTLargeP32-1.0decoder-30ep-640hw-tgqg_layer2-refcocog/20240415_211140/det_best.pth"
